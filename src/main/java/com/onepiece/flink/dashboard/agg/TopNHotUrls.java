...
import static com.onepiece.flink.common.CommonConst.MAP_STATE_DESCRIPTOR;
 ...
 * @author fengyafei
 */
public class TopNHotUrls extends KeyedProcessFunction<Long, UrlCountView, String> {

  private Integer topSize;

  public TopNHotUrls(Integer topSize) {
  ...
  public void onTimer(long timestamp, OnTimerContext ctx, Collector<String> out) throws Exception {
    ...
    for (int i = 0; i < Math.min(topSize, urlViewCounts.size()); i++) {
      Map.Entry<String, Long> currentItemViewCount = urlViewCounts.get(i);
      resultBuilder
          .append("NO ")
          .append(i + 1)
          .append(":")
